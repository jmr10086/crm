<%@ page import="cn.cheng.crm.settings.domain.DicValue" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.Map" %>
<%@ page import="java.util.Set" %>
<%@ page import="cn.cheng.crm.workbench.domain.Tran" %>
    ...
    <script type="text/javascript">
        ...
        * */
        ...
        function changeIcon(stage, index1) {
            ...
            //如果当前阶段的可能性为0 前7个一定是黑圈 后两个一个是红x 一个是黑X
...
<div style="position: relative; left: 40px; top: -50px;">
    ...
    <%
                ...
                //如果当前阶段的可能性不为0，前7个可能性有可能是绿圈 绿色标记 ，黑圈 后两个一定是黑叉
            } else {
                //准备当前阶段的下标
                int index = 0;
                for (int i = 0; i < dvList.size(); i++) {
    ...
    %>
                        ...
                        -----------
    <%
                //如果遍历出来阶段的可能性不为0，说明是前7个阶段 绿圈 ，绿色标记，黑圈
            } else {
