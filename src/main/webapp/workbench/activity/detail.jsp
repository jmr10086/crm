            ...
            $("#updateRemarkBtn").click(function (){
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        * */
                        if(data.success){
                            //修改内容成功，更新div中相应的信息，需要更新的内容有noteContent,editTime,editBy
                            $("#j"+id).html(data.ar.noteContent);
                            $("#c"+id).html(data.ar.editTime+" 由"+data.ar.editBy);
                            //更新内容之后，关闭模态窗口
                    ...
                    * */
                    ...
                    $.each(data, function (i, n) {
                        ...
                        *   将超链接禁用，只能以触发事件的形式来操作*/
                        ...
                        html += '<font color="gray">市场活动</font> <font color="gray">-</font> <b>${a.name}</b> <small style="color: gray;" id="c'+n.id+'"> ' + (n.editFlag == 0 ? n.createTime : n.editTime) + ' 由' + (n.editFlag == 0 ? n.createBy : n.editBy) + '</small>';
                        html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
