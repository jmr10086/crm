...
import cn.cheng.crm.workbench.dao.*;
import cn.cheng.crm.workbench.domain.*;
...
public class ClueServiceImpl implements ClueService {
    ...
    public boolean convert(String clueId, Tran t, String createBy) {
        ...
        //经过第二部处理后，客户的信息我们已经拥有了，将来再处理其他表的时候，如果要
        //用到客户的id，直接使用cus.getId();
        ...
        //经过第三部处理后，联想人的信息我们已经拥有了，将来再处理其他表的时候，如果要
        //用到联系人的id，直接使用con.getId();
        //(4)线索备注转换到客户备注以及联系人备注
        //查询出与该线索关联的备注信息列表
        List<ClueRemark> clueRemarkList = clueRemarkDao.getListByClueId(clueId);
        //取出每一条线索的备注
        for (ClueRemark clueRemark : clueRemarkList) {
            //取出备注信息（主要转换的客户备注信息和联系人备注的就是这个备注信息）
        ...
        if (t != null) {
             ...
             * id,monry,name,expectedDate,stage,activityId,createBy,createTime
             *
